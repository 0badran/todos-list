...
export default async function Completed() {
    ...
    if (!courses.length) return <Image className="mx-auto" unoptimized src="/images/complete-empty.gif" alt="complete task empty" width={450} height={300} />
