      ...
      {editingId === id ? (
        <form onSubmit={handleEditTask} className="flex h-full gap-2">
          ...
          <Button
            ...
            size="lg"
            type="submit"
            className="w-fit md:w-full mx-auto h-full max-md:p-4 focus:outline-hidden text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900"
          >
          ...
          <Button
            size="lg"
            className="w-fit md:w-full h-full mx-auto max-md:p-4"
            type="reset"
            variant={"secondary"}
        ...
        <div className="grid grid-cols-2 gap-2 h-full items-baseline ">
          <p className="font-bold line-clamp-1 text-gray-950 dark:text-white">
            {title}
          </p>
          <Button
            size="lg"
            className="w-fit mx-auto md:w-full h-full max-md:p-4 focus:outline-hidden text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm dark:focus:ring-yellow-900"
            onClick={() => openForm(id)}
          >
